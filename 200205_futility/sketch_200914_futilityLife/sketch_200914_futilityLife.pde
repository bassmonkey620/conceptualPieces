...
private float savedTime, totalTime;

private float bgColor = 255;
...
class Place {
  ...
  public void strengthen(float strongRed, float strongGreen, float strongBlue) {
    
    float strengthenOpacity = 50;
    color strengthenColor = color(strongRed, strongGreen, strongBlue, strengthenOpacity);

    placeColor = strengthenColor;
  }

  public void weaken() {
    float weakenOpacity = 10;
    color weakenColor = color(getBGColor(), weakenOpacity);
    placeColor = weakenColor;
  }
...
class Person {
  ...
  private int x, y;
  private float myRed, myGreen, myBlue;
  ...
  public Person(int homeX, int homeY) {
    ...
    myRed = random(50, 200);
    myGreen = random(50, 200);
    myBlue = random(50, 200);
  ...
  public void makeMove() {
    ...
    if (moveState == "backward1") {
      ...
      currentPlace.strengthen(myRed, myGreen, myBlue);
    }
